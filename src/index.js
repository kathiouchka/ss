...
async function main() {
  try {
    ...
    await tradeTokenWithJupiter("4DBgRWs63QzBwj71Qxiiz49DUZJi2QgUha7cbadepump", 20, true, 5);
    log(LOG_LEVELS.INFO, "WE WAIT 30 SECONDS", {
      isBot: true,
    });

    await delay(30000);
    await tradeTokenWithJupiter("4DBgRWs63QzBwj71Qxiiz49DUZJi2QgUha7cbadepump", 100, false, 5);
